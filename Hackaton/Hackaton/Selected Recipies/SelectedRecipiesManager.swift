...
class SelectedRecipiesManager: NSObject {
    ...
    override init() {
        ...
        let mushrooms = Ingredient(description: "Mushrooms", quantityUnit: .gram, pricePerKilo: 17.50, location: .fruits)
